    ...
    <div className={styles.chat} key={session.id}>
      ...
      {showInfoModal && (
          <div className={styles['modal-mask']}>
            ...
            >
              <div className={styles['modal-message']}>
                <span>很感谢您对夏夜小鹿的支持</span>
                <span>我们很高兴的通知您,我们的站点已经全部迁移到海外,只要openai不倒闭,我们将会永久提供免费服务,新网址为：tochat.xiayexiaolu.com</span>
                <span>另外我们非常希望您关注一下我们的小程序,获得您的免费永久key!(扫码进入小程序后,点击个人中心,下滑到关注作者,首次关注需要绑定邮箱,关注成功后您的邮箱将会收到您的专属key提醒邮件,之后您就可以用您的专属key来进行访问,没有任何的限制)</span>
                {imageToShow}
